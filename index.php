        ...
        <div class="articleTwoContainer">
            <article class="page pageTwo">
                ...
                <section class="center">
                    ...
                    <p>
                        We are proud to announce our latest release of PHProjekt.
                    ...
                    <p>
PHProjekt now comes with a new revolutionary way of timetracking. We enhanced the timecard to use the CalDav interface
to allow timekeeping from anywhere and with any CalDav enabled device, without the need to ever open your browser window.
                    </p>
<p>
The lists views, especially for the calendar web front-end have have been heavily optimized and now allow the listing
thousands of items without slowing down the browser. The general performance of the whole calendar system has been
improved as well to make it even more convenient to use CalDav or the web interface to manage events.
</p>
<p>
Tags and the general search have been merged to provide unified access to all the important informations.
In addition to that the search is now able to search for multiple tags which makes it possible to easily limit the
results to items matching multiple criteria.
</p>
<p>
The WebDav interface and the Filemanager are finally fully unified. This allows to access the same files via WebDav and
the web without the need to worry about data duplication.
</p>
                    <header>
                        <h3>Commercial</h3>
                    </header>
